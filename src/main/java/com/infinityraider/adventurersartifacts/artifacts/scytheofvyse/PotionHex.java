...
public class PotionHex extends Potion {
    private static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MOD_ID, "textures/gui/potion_scythe_of_vyse.png");

    public PotionHex() {
        super(false, new Color(0, 0, 0).getRGB());
        this.setPotionName(Reference.MOD_ID + ":potion.scythe_of_vyse");
    ...
    public void performEffect(EntityLivingBase entity, int amplification) {
        HexedHandler.getInstance().onHexedTick(entity);
